    ...
    <div className="min-h-screen flex flex-col items-center justify-between px-6 py-12 sm:py-20 bg-white text-neutral-900 font-mono">
      <main className="w-full max-w-3xl">
        ...
        <section className="space-y-8 text-sm sm:text-base leading-relaxed">
          <div>
            <h2 className="text-xl font-semibold mb-2 text-[#fe6f41]">1. Accettazione dei Termini</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold mb-2 text-[#fe6f41]">2. Utilizzo dell'App</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold mb-2 text-[#fe6f41]">3. Account e Autenticazione</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold mb-2 text-[#fe6f41]">4. Acquisti In-App e Abbonamenti</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold mb-2 text-[#fe6f41]">5. Conservazione dei Dati</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold mb-2 text-[#fe6f41]">6. Diritti degli Utenti e GDPR</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold mb-2 text-[#fe6f41]">7. Proprietà Intellettuale</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold mb-2 text-[#fe6f41]">8. Limitazione di Responsabilità</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold mb-2 text-[#fe6f41]">9. Assenza di Pubblicità e Servizi di Terze Parti</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold mb-2 text-[#fe6f41]">11. Aggiornamenti ai Termini</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold mb-2 text-[#fe6f41]">12. Contatti</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold mb-2 text-[#fe6f41]">13. Marchi Registrati</h2>
            <p>
